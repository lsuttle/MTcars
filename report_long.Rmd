...
h2 { font-size:1.8em; color: #2C2072; margin-bottom: 0px; padding-bottom: 0px}
...
library(knitr)
options(width = 100)
opts_chunk$set(comment=NA, message=FALSE, error=FALSE, warning=FALSE, echo=FALSE, collapse=TRUE, fig.align='left', dpi=96, tidy=FALSE, cache.path = '.cache/', fig.path = 'figures_long/')
...
par(oma=c(0, 0, 0, 0))
pairs(mtcars[,c("gp100m","wt","disp","hp","drat","cyl","am")], gap=0.5, pch=21, bg=cvec.fill.am, las=1, panel=mypanel, lower.panel=function(...) panel.cor(..., color.bg=TRUE), main="")
...
mtext(side=3, "Dashed lines show the 'y ~ x' regression. / Diamonds show the prediction of the best LM", outer=TRUE, line=-2.4, padj=1, cex=0.8, font=1)
