...
library(knitr)
options(width = 100)
opts_chunk$set(comment=NA, message=FALSE, error=FALSE, warning=FALSE, echo=FALSE, collapse=TRUE, fig.align='left', dpi=96, tidy=FALSE, cache.path = '.cache/', fig.path = 'figures/')
